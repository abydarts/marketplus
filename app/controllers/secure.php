...
class Secure extends Front_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('location_model','Blog_model','Updates_model'));
...
$breadcrumb = $this->breadcrumb->output();
 ...
 function details($id)
	...
	$data['base_url']			= $this->uri->segment_array();	//breadcrumb
		$data['updates']		= $this->Updates_model->get_update($id); 
		$data['body_content']	= 'updates_details';
		$this->load->view('template', $data);
	}	
		
	function updates(){
		$data['base_url']			= $this->uri->segment_array();	//breadcrumb
		$data['updates']				= $this->Updates_model->get_updates(); 
		$data['page_title']	= lang('news_updates');
		$data['body_content']	= 'updates';
		$this->load->view('template', $data);	
	}
//////////////////Blogs////////////////////	
	function blog(){
