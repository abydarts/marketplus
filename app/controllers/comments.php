...
class Comments extends CI_Controller {
	...
	function index()
	{
		$data['comments'] = $this->comments->generate_hierarchial_list('template/default/comm/hierarchy_comments_template', 'ul', 'id="comments"');
		...
		$data['body_content'] = 'comm/comments';
