...
var shipping_required = <?php echo ($this->bse_tec->requires_shipping()) ? 'true' : 'false'; ?>;
var shipping = Array();
var shipping_choice = '<?php $shipping=$this->bse_tec->shipping_method(); if($shipping) echo $shipping['method']; ?>';
...
cart_total = <?php echo $this->bse_tec->total(); ?>;
