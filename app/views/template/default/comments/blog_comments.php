...
<div class="comments">
    ...
    ?>
        <div class="post_comment_con marbot15">
            <a href="<?php echo site_url('profile').'/'.$comment->user_id ?>"><div class="left tip posted_avator" title="<?php echo $comment->user_firstname.' '.$comment->user_lastname;?> Said">
                <img class="avatar" src="<?php echo base_url('uploads/profile/'.$comment->avatar) ?>" width="60" height="60" />
            </div></a>
...
<div class="add_comment">
    ...
    <?php $users = $this->bse_tec->customer() ?>
        ...
        <p class="textarea left">
            ...
            <input class="left" value="<?php echo lang('SEND');?>" type="submit" />

				<input id="path_val" value="<?php echo site_url('secure/ajax'); ?>" type="hidden" />
        </p>
    </div>
